...
# def shiftsCosts(array):
#     labourCostDict = {}
#     for dict in array:
#         startTime = datetime.datetime.strptime(
#             dict['start_time'], '%H:%M').time()
#         endTime = datetime.datetime.strptime(
#             dict['end_time'], '%H:%M').time()
#         breakTime = datetime.datetime.strptime(
#             dict['break_time'], '%H:%M:%S').time()
...
#             datetime.date.today(), endTime)
#         dateTimeC = datetime.datetime.combine(
#             datetime.date.today(), breakTime)

#         # Substracting since we have time point with timedelta
#         timeDifference = dateTimeB - dateTimeA

#         # Coverting timeDifference to datetime then to timedelta
#         convertTimeDiff = datetime.datetime.strptime(
#             str(timeDifference), '%H:%M:%S').time()

#         dateTimeD = datetime.datetime.combine(
#             datetime.date.today(), convertTimeDiff)

#         # Getting final working shift hour.
#         shiftMinusBreak = dateTimeD - dateTimeC
#         payRatePerM = float(dict["pay_rate"]) / 60
#         shiftInMinutes = shiftMinusBreak.total_seconds() / 60.0

#         labourCostDict[dict["start_time"]] = shiftInMinutes * payRatePerM
#         print(labourCostDict)
...
print("=== TASK 1 ===")
print("")
print(process_shifts("/Users/lhngo/Downloads/Tenzo Coding Test/work_shifts.csv"))
print("")
print("=== TASK 2 ===")
...
print("")
print(process_sales("/Users/lhngo/Downloads/Tenzo Coding Test/transactions.csv"))
print("")
print("=== TASK 3 ===")


sales = process_sales(
    "/Users/lhngo/Downloads/Tenzo Coding Test/transactions.csv")
shifts = process_shifts(
    "/Users/lhngo/Downloads/Tenzo Coding Test/work_shifts.csv")
...
print("")
print(best_and_worst_hour(percentages))
print("")
print("=== END ===")
